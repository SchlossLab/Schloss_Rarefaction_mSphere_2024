...
vegan (v.2.6.2) R package (5). The adonis2 function implements a
non-parametric multivariate analysis of variance using distances
matrices as described by McArdle and Anderson (6). Throughout this study
I used 0.05 as the threshold for asssessing statistical significance.
...
and Shannon and inverse Simpson diversity using mothur (2, 7). Shannon
...
using the SRS R package (v.0.2.3)(8). Normalized OTU counts were used to
...
procedure (9). The non-parametric bias-corrected Chao1 and ACE richness
estimators (10) and a non-parametric estimator of the Shannon diversity
(11) were calculated using raw OTU counts with mothur. Parametric
estimates of sample richness were calculated using the breakaway (BA) R
package (v.4.7.9)(12). The current analysis reports both the results
...
package (v.2.6.2)(5). The Jaccard index was calculated as
...
(v.0.2.3) and metagenomeSeq (v.1.36.0) R packages, respectively (8, 9).
The normalized counts were then used to calculate Jaccard and
...
was used to normalize the data as described by McMurdie and Holmes (13,
14). Because the VST approach generates negative values, which are
...
(15). The second, One CLR, added a pseudocount of 1 to the abundance of
all OTUs (9, 16). The third, Nudge CLR, added a pseudocount of 1 divided
by the total number of sequences in a sample to each OTU in the sample
(16, 17). The final approach, Robust CLR, removed unobserved OTUs prior
to calcualting the CLR (18).
...
\midrule()
\endhead
Bioethanol~(19) & 95 & 3,970,972 & 16,014 & 3,690\Hyphdash*356,027 &
SRP055545 \\
Human~(20) & 490 & 20,828,275 & 32,452 & 10,439\Hyphdash*422,904 &
SRP062005 \\
Lake~(21) & 52 & 3,145,486 & 69,205 & 15,135\Hyphdash*110,993 &
SRP050963 \\
Marine~(22) & 7 & 1,484,068 & 213,091 & 132,895\Hyphdash*256,758 &
SRP068101 \\
Mice~(1) & 348 & 2,785,641 & 6,426 & 1,804\Hyphdash*30,311 &
SRP192323 \\
Peromyscus~(23) & 111 & 1,545,288 & 12,393 & 4,454\Hyphdash*33,502 &
SRP044050 \\
Rainforest~(24) & 69 & 936,666 & 11,464 & 4,880\Hyphdash*37,403 &
ERP023747 \\
Rice~(25) & 490 & 22,623,937 & 43,399 & 2,777\Hyphdash*192,200 &
SRP044745 \\
Seagrass~(26) & 286 & 4,135,440 & 13,538 & 1,830\Hyphdash*45,076 &
SRP092441 \\
Sediment~(27) & 58 & 1,151,389 & 17,606 & 7,686\Hyphdash*67,763 &
SRP097192 \\
Soil~(28) & 18 & 932,563 & 50,487 & 46,622\Hyphdash*58,935 &
ERP012016 \\
Stream~(29) & 201 & 21,017,610 & 90,621 & 8,931\Hyphdash*394,419 &
SRP075852 \\
\bottomrule()
\end{longtable}
